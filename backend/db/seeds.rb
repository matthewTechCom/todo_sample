coupons = [
  ...
  },
  {
    ...
    starts_at: Time.zone.parse("2026-03-01 00:00:00"),
    ends_at: Time.zone.parse("2026-10-31 23:59:59"),
    display_order: 20,
    published: true
  },
  {
    ...
    starts_at: Time.zone.parse("2026-03-15 00:00:00"),
    ends_at: Time.zone.parse("2026-09-30 23:59:59"),
    display_order: 30,
    published: true
  },
  {
    ...
    starts_at: Time.zone.parse("2026-03-10 00:00:00"),
    ends_at: Time.zone.parse("2026-11-30 23:59:59"),
    display_order: 40,
    published: true
  }
]

coupons.each do |attributes|
  coupon = Coupon.find_or_initialize_by(slug: attributes[:slug])
  coupon.assign_attributes(attributes)
  coupon.save!
end
